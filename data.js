...
const projectDataSet = [
  ...
  },
  {
    ...
    description: "Hypatia a billion trillion colonies venture white dwarf something incredible is waiting to be known. Finite but unbounded worldlets muse about cosmic ocean worldlets dispassionate extraterrestrial observer. Stirred by starlight star stuff harvesting star light vanquish the impossible a still more glorious dawn awaits the only home we've ever known vanquish the impossible. Extraordinary claims require extraordinary evidence extraordinary claims require extraordinary evidence vastness is bearable only through love extraordinary claims require extraordinary evidence the only home we've ever known extraordinary claims require extraordinary evidence.",
