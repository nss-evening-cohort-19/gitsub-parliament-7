...
const repo = [
  ...
  },
  {
    ...
    description:
      "Test test Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi  test",
    url: `https://github.com/TwoFivinClimber/loops-data`,
    tags: ["rihanna"],
    pinned: false,
    primaryLang: "Javascript",
    branches: 3,
  ...
  },
  {
    ...
    description:
      "Test test Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi  test",
    url: `https://github.com/TwoFivinClimber/LAB-word-counter`,
    tags: ["donation", "landing-page", "rihanna"],
    pinned: true,
    primaryLang: "Javascript",
    branches: 26,
  ...
  {
    id: 8,
    name: "PRACTICE-youtube-player",
    description:
      "Test test Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi  test",
    url: `https://github.com/TwoFivinClimber/PRACTICE-youtube-player`,
  ...
  },
  {
    ...
    description:
      "Test test Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi  test",
    url: `https://github.com/TwoFivinClimber/link-in-bio`,
    tags: ["donation", "landing-page", "rihanna"],
    pinned: true,
    primaryLang: "Javascript",
    branches: 9,
...
const projectDataSet = [
  {
    ...
    name: "Gitsub",
    description:
      "Worldlets birth corpus callosum are creatures of the cosmos Rig Veda science? Made in the interiors of collapsing stars descended from astronomers how far away inconspicuous motes of rock and gas colonies colonies.",
  ...
  },
  {
    ...
    description:
      "Globular star cluster cosmos dispassionate extraterrestrial observer light years of brilliant syntheses dream of the mind's eye?",
  ...
  },
  {
    ...
    description:
      "Extraordinary claims require extraordinary evidence extraordinary claims require extraordinary evidence vastness is bearable only through love extraordinary claims require extraordinary evidence the only home we've ever known extraordinary claims require extraordinary evidence.",
